    ...
    <div id="create-new-blog" class="fixed inset-0 z-[99999] hidden items-center justify-center p-4 animate-fade-in">
        ...
        <div class="bg-white max-w-2xl w-full rounded-xl shadow-2xl relative border border-white/20 overflow-hidden">
            ...
            <div class="p-8 max-h-96 overflow-y-auto custom-scrollbar">
                <form id="create_blog" action="{{ route('blogs.store') }}" method="POST"
    ...
    @foreach ($blogs as $blog)
        <div id="edit-blog-{{ $blog->slug }}"
            ...
            <div
                ...
                <div class="p-8 max-h-96 overflow-y-auto custom-scrollbar">
                    <form id="edit_blog" action="{{ route('blogs.update', $blog->id) }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="space-y-6">
                            ...
                            <div class="group">
                                ...
                                <input type="hidden" name="content" id="content" class="quill-hidden">

                                <div class="quill-editor rounded-b-lg border border-text/25"
                                    style="background: white; height: 200px;">{!! $blog->content ?? '' !!}</div>
                            </div>
