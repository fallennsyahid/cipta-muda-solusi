...
<body class="bg-accent flex items-center justify-center min-h-screen">
    <div class="text-center px-6">
        ...
        <h2 class="text-3xl font-semibold text-primary mt-2">Halaman Tidak Ditemukan</h2>
        ...
        <button type="button"
            ...
            class="inline-block mt-8 px-6 py-3 rounded-lg text-white font-medium bg-primary hover:bg-secondary transition duration-300 cursor-pointer">
            Kembali ke Beranda
        </button>

        <div class="mt-10">
            <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto w-40 h-40 text-primary opacity-75" fill="none"
